...
public class AkronFacilityData {
	 private static final ConfigLoader loginconfig = new ConfigLoader("login.properties");
	 private static final ConfigLoader facilityconfig = new ConfigLoader("akronfacility.properties");
    ...
    public static final String STORAGE_CONDITION = facilityconfig.get("storageCondition");
