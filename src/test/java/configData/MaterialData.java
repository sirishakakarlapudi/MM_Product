...
public class MaterialData {
	 ...
	 private static final ConfigLoader materialconfig = new ConfigLoader("material.properties");
    ...
    public static final String STORAGE_CONDITION= materialconfig.get("storageCondition");
    ...
    public static final String MIXED_ANALYSIS= materialconfig.get("mixedAnalysis");
    public static final String WEIGHT_VERIFICATION= materialconfig.get("weightVerification");
    public static final String RECEIVING_BAY= materialconfig.get("receivingBay");
